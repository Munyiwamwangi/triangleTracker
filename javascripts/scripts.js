function identifier() {
  ...
  if (side1 > 0 && side2 > 0 && side3 > 0) {
    if (side1 === side2 && side1 === side3 && side2 === side3) {
      ...
      alert(" OOPS, Your values can not form any triangle. Sum of two sides should be greater than the remaining side.")
    ...
    alert("Ensure all spaces are filled and All Values must be greater than zero;");
  }
}
